...
#if _USE_DECLSPECS_FOR_SAL &&                                                                                          \
		(defined(MIDL_PASS) || defined(__midl) || defined(RC_INVOKED) || !defined(_PREFAST_)) /*IFSTRIP=IGN*/ // [
#undef _USE_DECLSPECS_FOR_SAL
#define _USE_DECLSPECS_FOR_SAL 0
#endif // ]
#if _USE_ATTRIBUTES_FOR_SAL &&                                                                                         \
		(!defined(_MSC_EXTENSIONS) || defined(MIDL_PASS) || defined(__midl) ||                                         \
				defined(RC_INVOKED)) /*IFSTRIP=IGN*/ // [
#undef _USE_ATTRIBUTES_FOR_SAL
#define _USE_ATTRIBUTES_FOR_SAL 0
#endif // ]
...
#define _In_                                                                                                           \
	_SAL2_Source_(                                                                                                     \
			_In_, (), _Pre1_impl_(__notnull_impl_notref) _Pre_valid_impl_ _Deref_pre1_impl_(__readaccess_impl_notref))
...
#define _Inout_updates_z_(size)                                                                                        \
	_SAL2_Source_(_Inout_updates_z_, (size),                                                                           \
			_Pre_cap_(size) _Pre_valid_impl_ _Post_valid_impl_ _Pre1_impl_(__zterm_impl) _Post1_impl_(__zterm_impl))
...
#define _Outptr_result_maybenull_                                                                                      \
	_SAL2_Source_(                                                                                                     \
			_Outptr_result_maybenull_, (), _Out_impl_ _Deref_post2_impl_(__maybenull_impl_notref, __count_impl(1)))
#define _Outptr_opt_                                                                                                   \
...
#define _Outptr_result_buffer_(size)                                                                                   \
	_SAL2_Source_(                                                                                                     \
			_Outptr_result_buffer_, (size), _Out_impl_ _Deref_post2_impl_(__notnull_impl_notref, __cap_impl(size)))
...
#define _Outref_result_buffer_to_(size, count)                                                                         \
	_SAL2_Source_(                                                                                                     \
			_Outref_result_buffer_to_, (size, count), _Outref_result_buffer_(size) _Post1_impl_(__count_impl(count)))
...
#define _Ret_writes_z_(size)                                                                                           \
	_SAL2_Source_(                                                                                                     \
			_Ret_writes_z_, (size), _Ret3_impl_(__notnull_impl, __count_impl(size), __zterm_impl) _Ret_valid_impl_)
...
#define _Field_size_part_opt_(size, count)                                                                             \
	_SAL2_Source_(                                                                                                     \
			_Field_size_part_opt_, (size, count), _Maybenull_ _Writable_elements_(size) _Readable_elements_(count))
...
#define _Field_size_bytes_part_opt_(size, count)                                                                       \
	_SAL2_Source_(                                                                                                     \
			_Field_size_bytes_part_opt_, (size, count), _Maybenull_ _Writable_bytes_(size) _Readable_bytes_(count))
...
#define _Out_bytecap_post_bytecount_(cap, count)                                                                       \
	_SAL1_1_Source_(                                                                                                   \
			_Out_bytecap_post_bytecount_, (cap, count), _Pre_bytecap_(cap) _Post_valid_impl_ _Post_bytecount_(count))
...
#define _Out_opt_z_cap_post_count_(cap, count)                                                                         \
	_SAL1_1_Source_(                                                                                                   \
			_Out_opt_z_cap_post_count_, (cap, count), _Pre_opt_cap_(cap) _Post_valid_impl_ _Post_z_count_(count))
...
#define _Out_bytecapcount_(capcount)                                                                                   \
	_SAL1_1_Source_(                                                                                                   \
			_Out_bytecapcount_, (capcount), _Pre_bytecap_(capcount) _Post_valid_impl_ _Post_bytecount_(capcount))
...
#define _Out_opt_capcount_x_(capcount)                                                                                 \
	_SAL1_1_Source_(                                                                                                   \
			_Out_opt_capcount_x_, (capcount), _Pre_opt_cap_x_(capcount) _Post_valid_impl_ _Post_count_x_(capcount))
...
#define _Out_opt_z_capcount_(capcount)                                                                                 \
	_SAL1_1_Source_(                                                                                                   \
			_Out_opt_z_capcount_, (capcount), _Pre_opt_cap_(capcount) _Post_valid_impl_ _Post_z_count_(capcount))
#define _Out_z_bytecapcount_(capcount)                                                                                 \
	_SAL1_1_Source_(                                                                                                   \
			_Out_z_bytecapcount_, (capcount), _Pre_bytecap_(capcount) _Post_valid_impl_ _Post_z_bytecount_(capcount))
...
#define _Deref_pre_cap_(size)                                                                                          \
	_SAL1_1_Source_(                                                                                                   \
			_Deref_pre_cap_, (size), _Deref_pre1_impl_(__notnull_impl_notref) _Deref_pre1_impl_(__cap_impl(size)))
...
#define _Deref_pre_cap_c_(size)                                                                                        \
	_SAL1_1_Source_(                                                                                                   \
			_Deref_pre_cap_c_, (size), _Deref_pre1_impl_(__notnull_impl_notref) _Deref_pre1_impl_(__cap_c_impl(size)))
...
#define _Deref_pre_cap_x_(size)                                                                                        \
	_SAL1_1_Source_(                                                                                                   \
			_Deref_pre_cap_x_, (size), _Deref_pre1_impl_(__notnull_impl_notref) _Deref_pre1_impl_(__cap_x_impl(size)))
...
#define _Deref_pre_opt_valid_bytecap_(size)                                                                            \
	_SAL1_1_Source_(_Deref_pre_opt_valid_bytecap_, (size),                                                             \
			_Deref_pre1_impl_(__maybenull_impl_notref) _Deref_pre1_impl_(__bytecap_impl(size)) _Pre_valid_impl_)
...
#define _Deref_pre_valid_bytecap_c_(size)                                                                              \
	_SAL1_1_Source_(_Deref_pre_valid_bytecap_c_, (size),                                                               \
			_Deref_pre1_impl_(__notnull_impl_notref) _Deref_pre1_impl_(__bytecap_c_impl(size)) _Pre_valid_impl_)
#define _Deref_pre_opt_valid_bytecap_c_(size)                                                                          \
	_SAL1_1_Source_(_Deref_pre_opt_valid_bytecap_c_, (size),                                                           \
			_Deref_pre1_impl_(__maybenull_impl_notref) _Deref_pre1_impl_(__bytecap_c_impl(size)) _Pre_valid_impl_)
...
#define _Deref_pre_valid_bytecap_x_(size)                                                                              \
	_SAL1_1_Source_(_Deref_pre_valid_bytecap_x_, (size),                                                               \
			_Deref_pre1_impl_(__notnull_impl_notref) _Deref_pre1_impl_(__bytecap_x_impl(size)) _Pre_valid_impl_)
#define _Deref_pre_opt_valid_bytecap_x_(size)                                                                          \
	_SAL1_1_Source_(_Deref_pre_opt_valid_bytecap_x_, (size),                                                           \
			_Deref_pre1_impl_(__maybenull_impl_notref) _Deref_pre1_impl_(__bytecap_x_impl(size)) _Pre_valid_impl_)
...
#define _Deref_pre_bytecount_(size)                                                                                    \
	_SAL1_1_Source_(_Deref_pre_bytecount_, (size),                                                                     \
			_Deref_pre1_impl_(__notnull_impl_notref) _Deref_pre1_impl_(__bytecount_impl(size)) _Pre_valid_impl_)
#define _Deref_pre_opt_bytecount_(size)                                                                                \
	_SAL1_1_Source_(_Deref_pre_opt_bytecount_, (size),                                                                 \
			_Deref_pre1_impl_(__maybenull_impl_notref) _Deref_pre1_impl_(__bytecount_impl(size)) _Pre_valid_impl_)
...
#define _Deref_pre_opt_count_c_(size)                                                                                  \
	_SAL1_1_Source_(_Deref_pre_opt_count_c_, (size),                                                                   \
			_Deref_pre1_impl_(__maybenull_impl_notref) _Deref_pre1_impl_(__count_c_impl(size)) _Pre_valid_impl_)
#define _Deref_pre_bytecount_c_(size)                                                                                  \
	_SAL1_1_Source_(_Deref_pre_bytecount_c_, (size),                                                                   \
			_Deref_pre1_impl_(__notnull_impl_notref) _Deref_pre1_impl_(__bytecount_c_impl(size)) _Pre_valid_impl_)
#define _Deref_pre_opt_bytecount_c_(size)                                                                              \
	_SAL1_1_Source_(_Deref_pre_opt_bytecount_c_, (size),                                                               \
			_Deref_pre1_impl_(__maybenull_impl_notref) _Deref_pre1_impl_(__bytecount_c_impl(size)) _Pre_valid_impl_)
...
#define _Deref_pre_opt_count_x_(size)                                                                                  \
	_SAL1_1_Source_(_Deref_pre_opt_count_x_, (size),                                                                   \
			_Deref_pre1_impl_(__maybenull_impl_notref) _Deref_pre1_impl_(__count_x_impl(size)) _Pre_valid_impl_)
#define _Deref_pre_bytecount_x_(size)                                                                                  \
	_SAL1_1_Source_(_Deref_pre_bytecount_x_, (size),                                                                   \
			_Deref_pre1_impl_(__notnull_impl_notref) _Deref_pre1_impl_(__bytecount_x_impl(size)) _Pre_valid_impl_)
#define _Deref_pre_opt_bytecount_x_(size)                                                                              \
	_SAL1_1_Source_(_Deref_pre_opt_bytecount_x_, (size),                                                               \
			_Deref_pre1_impl_(__maybenull_impl_notref) _Deref_pre1_impl_(__bytecount_x_impl(size)) _Pre_valid_impl_)
...
#define _Deref_post_cap_(size)                                                                                         \
	_SAL1_1_Source_(                                                                                                   \
			_Deref_post_cap_, (size), _Deref_post1_impl_(__notnull_impl_notref) _Deref_post1_impl_(__cap_impl(size)))
...
#define _Deref_post_opt_z_bytecap_c_(size)                                                                             \
	_SAL1_1_Source_(_Deref_post_opt_z_bytecap_c_, (size),                                                              \
			_Deref_post1_impl_(__maybenull_impl_notref) _Deref_post2_impl_(__zterm_impl, __bytecap_c_impl(size))       \
					_Post_valid_impl_)
...
#define _Deref_post_opt_z_bytecap_x_(size)                                                                             \
	_SAL1_1_Source_(_Deref_post_opt_z_bytecap_x_, (size),                                                              \
			_Deref_post1_impl_(__maybenull_impl_notref) _Deref_post2_impl_(__zterm_impl, __bytecap_x_impl(size))       \
					_Post_valid_impl_)
...
#define _Deref_post_opt_valid_cap_(size)                                                                               \
	_SAL1_1_Source_(_Deref_post_opt_valid_cap_, (size),                                                                \
			_Deref_post1_impl_(__maybenull_impl_notref) _Deref_post1_impl_(__cap_impl(size)) _Post_valid_impl_)
#define _Deref_post_valid_bytecap_(size)                                                                               \
	_SAL1_1_Source_(_Deref_post_valid_bytecap_, (size),                                                                \
			_Deref_post1_impl_(__notnull_impl_notref) _Deref_post1_impl_(__bytecap_impl(size)) _Post_valid_impl_)
#define _Deref_post_opt_valid_bytecap_(size)                                                                           \
	_SAL1_1_Source_(_Deref_post_opt_valid_bytecap_, (size),                                                            \
			_Deref_post1_impl_(__maybenull_impl_notref) _Deref_post1_impl_(__bytecap_impl(size)) _Post_valid_impl_)

#define _Deref_post_valid_cap_c_(size)                                                                                 \
	_SAL1_1_Source_(_Deref_post_valid_cap_c_, (size),                                                                  \
			_Deref_post1_impl_(__notnull_impl_notref) _Deref_post1_impl_(__cap_c_impl(size)) _Post_valid_impl_)
#define _Deref_post_opt_valid_cap_c_(size)                                                                             \
	_SAL1_1_Source_(_Deref_post_opt_valid_cap_c_, (size),                                                              \
			_Deref_post1_impl_(__maybenull_impl_notref) _Deref_post1_impl_(__cap_c_impl(size)) _Post_valid_impl_)
#define _Deref_post_valid_bytecap_c_(size)                                                                             \
	_SAL1_1_Source_(_Deref_post_valid_bytecap_c_, (size),                                                              \
			_Deref_post1_impl_(__notnull_impl_notref) _Deref_post1_impl_(__bytecap_c_impl(size)) _Post_valid_impl_)
#define _Deref_post_opt_valid_bytecap_c_(size)                                                                         \
	_SAL1_1_Source_(_Deref_post_opt_valid_bytecap_c_, (size),                                                          \
			_Deref_post1_impl_(__maybenull_impl_notref) _Deref_post1_impl_(__bytecap_c_impl(size)) _Post_valid_impl_)

#define _Deref_post_valid_cap_x_(size)                                                                                 \
	_SAL1_1_Source_(_Deref_post_valid_cap_x_, (size),                                                                  \
			_Deref_post1_impl_(__notnull_impl_notref) _Deref_post1_impl_(__cap_x_impl(size)) _Post_valid_impl_)
#define _Deref_post_opt_valid_cap_x_(size)                                                                             \
	_SAL1_1_Source_(_Deref_post_opt_valid_cap_x_, (size),                                                              \
			_Deref_post1_impl_(__maybenull_impl_notref) _Deref_post1_impl_(__cap_x_impl(size)) _Post_valid_impl_)
#define _Deref_post_valid_bytecap_x_(size)                                                                             \
	_SAL1_1_Source_(_Deref_post_valid_bytecap_x_, (size),                                                              \
			_Deref_post1_impl_(__notnull_impl_notref) _Deref_post1_impl_(__bytecap_x_impl(size)) _Post_valid_impl_)
#define _Deref_post_opt_valid_bytecap_x_(size)                                                                         \
	_SAL1_1_Source_(_Deref_post_opt_valid_bytecap_x_, (size),                                                          \
			_Deref_post1_impl_(__maybenull_impl_notref) _Deref_post1_impl_(__bytecap_x_impl(size)) _Post_valid_impl_)

// e.g. HRESULT HrAllocateZeroInitializedMemory( size_t cb, _Out_ _Deref_post_bytecount_(cb) void** ppv );
// valid buffer extent is described by another parameter
#define _Deref_post_count_(size)                                                                                       \
	_SAL1_1_Source_(_Deref_post_count_, (size),                                                                        \
			_Deref_post1_impl_(__notnull_impl_notref) _Deref_post1_impl_(__count_impl(size)) _Post_valid_impl_)
#define _Deref_post_opt_count_(size)                                                                                   \
	_SAL1_1_Source_(_Deref_post_opt_count_, (size),                                                                    \
			_Deref_post1_impl_(__maybenull_impl_notref) _Deref_post1_impl_(__count_impl(size)) _Post_valid_impl_)
#define _Deref_post_bytecount_(size)                                                                                   \
	_SAL1_1_Source_(_Deref_post_bytecount_, (size),                                                                    \
			_Deref_post1_impl_(__notnull_impl_notref) _Deref_post1_impl_(__bytecount_impl(size)) _Post_valid_impl_)
#define _Deref_post_opt_bytecount_(size)                                                                               \
	_SAL1_1_Source_(_Deref_post_opt_bytecount_, (size),                                                                \
			_Deref_post1_impl_(__maybenull_impl_notref) _Deref_post1_impl_(__bytecount_impl(size)) _Post_valid_impl_)

// buffer capacity is described by a constant expression
#define _Deref_post_count_c_(size)                                                                                     \
	_SAL1_1_Source_(_Deref_post_count_c_, (size),                                                                      \
			_Deref_post1_impl_(__notnull_impl_notref) _Deref_post1_impl_(__count_c_impl(size)) _Post_valid_impl_)
#define _Deref_post_opt_count_c_(size)                                                                                 \
	_SAL1_1_Source_(_Deref_post_opt_count_c_, (size),                                                                  \
			_Deref_post1_impl_(__maybenull_impl_notref) _Deref_post1_impl_(__count_c_impl(size)) _Post_valid_impl_)
#define _Deref_post_bytecount_c_(size)                                                                                 \
	_SAL1_1_Source_(_Deref_post_bytecount_c_, (size),                                                                  \
			_Deref_post1_impl_(__notnull_impl_notref) _Deref_post1_impl_(__bytecount_c_impl(size)) _Post_valid_impl_)
...
#define _Deref_post_count_x_(size)                                                                                     \
	_SAL1_1_Source_(_Deref_post_count_x_, (size),                                                                      \
			_Deref_post1_impl_(__notnull_impl_notref) _Deref_post1_impl_(__count_x_impl(size)) _Post_valid_impl_)
#define _Deref_post_opt_count_x_(size)                                                                                 \
	_SAL1_1_Source_(_Deref_post_opt_count_x_, (size),                                                                  \
			_Deref_post1_impl_(__maybenull_impl_notref) _Deref_post1_impl_(__count_x_impl(size)) _Post_valid_impl_)
#define _Deref_post_bytecount_x_(size)                                                                                 \
	_SAL1_1_Source_(_Deref_post_bytecount_x_, (size),                                                                  \
			_Deref_post1_impl_(__notnull_impl_notref) _Deref_post1_impl_(__bytecount_x_impl(size)) _Post_valid_impl_)
...
#define _Ret_opt_bytecap_c_(size)                                                                                      \
	_SAL1_1_Source_(                                                                                                   \
			_Ret_opt_bytecap_c_, (size), _Ret1_impl_(__maybenull_impl_notref) _Ret1_impl_(__bytecap_c_impl(size)))
...
#define _Ret_opt_bytecap_x_(size)                                                                                      \
	_SAL1_1_Source_(                                                                                                   \
			_Ret_opt_bytecap_x_, (size), _Ret1_impl_(__maybenull_impl_notref) _Ret1_impl_(__bytecap_x_impl(size)))
...
#define _Ret_z_bytecap_(size)                                                                                          \
	_SAL1_1_Source_(_Ret_z_bytecap_, (size),                                                                           \
			_Ret1_impl_(__notnull_impl_notref) _Ret2_impl_(__zterm_impl, __bytecap_impl(size)) _Ret_valid_impl_)
#define _Ret_opt_z_bytecap_(size)                                                                                      \
	_SAL1_1_Source_(_Ret_opt_z_bytecap_, (size),                                                                       \
			_Ret1_impl_(__maybenull_impl_notref) _Ret2_impl_(__zterm_impl, __bytecap_impl(size)) _Ret_valid_impl_)

// e.g. _Ret_opt_bytecount_(cb) void* AllocateZeroInitializedMemory( size_t cb );
// Valid Buffer extent is described by another parameter
#define _Ret_count_(size)                                                                                              \
	_SAL1_1_Source_(                                                                                                   \
			_Ret_count_, (size), _Ret1_impl_(__notnull_impl_notref) _Ret1_impl_(__count_impl(size)) _Ret_valid_impl_)
...
#define _Ret_opt_z_count_(size)                                                                                        \
	_SAL1_1_Source_(_Ret_opt_z_count_, (size),                                                                         \
			_Ret1_impl_(__maybenull_impl_notref) _Ret2_impl_(__zterm_impl, __count_impl(size)) _Ret_valid_impl_)
#define _Ret_z_bytecount_(size)                                                                                        \
	_SAL1_1_Source_(_Ret_z_bytecount_, (size),                                                                         \
			_Ret1_impl_(__notnull_impl_notref) _Ret2_impl_(__zterm_impl, __bytecount_impl(size)) _Ret_valid_impl_)
#define _Ret_opt_z_bytecount_(size)                                                                                    \
	_SAL1_1_Source_(_Ret_opt_z_bytecount_, (size),                                                                     \
			_Ret1_impl_(__maybenull_impl_notref) _Ret2_impl_(__zterm_impl, __bytecount_impl(size)) _Ret_valid_impl_)
...
#define _Pre_opt_bytecap_c_(size)                                                                                      \
	_SAL1_1_Source_(                                                                                                   \
			_Pre_opt_bytecap_c_, (size), _Pre1_impl_(__maybenull_impl_notref) _Pre1_impl_(__bytecap_c_impl(size)))
...
#define _Pre_opt_cap_m_(mult, size)                                                                                    \
	_SAL1_1_Source_(                                                                                                   \
			_Pre_opt_cap_m_, (mult, size), _Pre1_impl_(__maybenull_impl_notref) _Pre1_impl_(__mult_impl(mult, size)))
...
#define _Pre_opt_bytecap_x_(size)                                                                                      \
	_SAL1_1_Source_(                                                                                                   \
			_Pre_opt_bytecap_x_, (size), _Pre1_impl_(__maybenull_impl_notref) _Pre1_impl_(__bytecap_x_impl(size)))

// buffer capacity described by the difference to another pointer parameter
#define _Pre_ptrdiff_cap_(ptr)                                                                                         \
	_SAL1_1_Source_(                                                                                                   \
			_Pre_ptrdiff_cap_, (ptr), _Pre1_impl_(__notnull_impl_notref) _Pre1_impl_(__cap_x_impl(__ptrdiff(ptr))))
...
#define _Pre_z_bytecap_(size)                                                                                          \
	_SAL1_1_Source_(_Pre_z_bytecap_, (size),                                                                           \
			_Pre1_impl_(__notnull_impl_notref) _Pre2_impl_(__zterm_impl, __bytecap_impl(size)) _Pre_valid_impl_)
#define _Pre_opt_z_bytecap_(size)                                                                                      \
	_SAL1_1_Source_(_Pre_opt_z_bytecap_, (size),                                                                       \
			_Pre1_impl_(__maybenull_impl_notref) _Pre2_impl_(__zterm_impl, __bytecap_impl(size)) _Pre_valid_impl_)
...
#define _Pre_opt_z_cap_c_(size)                                                                                        \
	_SAL1_1_Source_(_Pre_opt_z_cap_c_, (size),                                                                         \
			_Pre1_impl_(__maybenull_impl_notref) _Pre2_impl_(__zterm_impl, __cap_c_impl(size)) _Pre_valid_impl_)
#define _Pre_z_bytecap_c_(size)                                                                                        \
	_SAL1_1_Source_(_Pre_z_bytecap_c_, (size),                                                                         \
			_Pre1_impl_(__notnull_impl_notref) _Pre2_impl_(__zterm_impl, __bytecap_c_impl(size)) _Pre_valid_impl_)
...
#define _Pre_opt_z_cap_x_(size)                                                                                        \
	_SAL1_1_Source_(_Pre_opt_z_cap_x_, (size),                                                                         \
			_Pre1_impl_(__maybenull_impl_notref) _Pre2_impl_(__zterm_impl, __cap_x_impl(size)) _Pre_valid_impl_)
#define _Pre_z_bytecap_x_(size)                                                                                        \
	_SAL1_1_Source_(_Pre_z_bytecap_x_, (size),                                                                         \
			_Pre1_impl_(__notnull_impl_notref) _Pre2_impl_(__zterm_impl, __bytecap_x_impl(size)) _Pre_valid_impl_)
#define _Pre_opt_z_bytecap_x_(size)                                                                                    \
	_SAL1_1_Source_(_Pre_opt_z_bytecap_x_, (size),                                                                     \
			_Pre1_impl_(__maybenull_impl_notref) _Pre2_impl_(__zterm_impl, __bytecap_x_impl(size)) _Pre_valid_impl_)
...
#define _Pre_count_(size)                                                                                              \
	_SAL1_1_Source_(                                                                                                   \
			_Pre_count_, (size), _Pre1_impl_(__notnull_impl_notref) _Pre1_impl_(__count_impl(size)) _Pre_valid_impl_)
...
#define _Post_z_bytecount_c_(size)                                                                                     \
	_SAL1_1_Source_(                                                                                                   \
			_Post_z_bytecount_c_, (size), _Post2_impl_(__zterm_impl, __bytecount_c_impl(size)) _Post_valid_impl_)
...
#define _Post_z_bytecount_x_(size)                                                                                     \
	_SAL1_1_Source_(                                                                                                   \
			_Post_z_bytecount_x_, (size), _Post2_impl_(__zterm_impl, __bytecount_x_impl(size)) _Post_valid_impl_)
...
#define _Deref_prepost_opt_bytecap_x_(size)                                                                            \
	_SAL1_1_Source_(                                                                                                   \
			_Deref_prepost_opt_bytecap_x_, (size), _Deref_pre_opt_bytecap_x_(size) _Deref_post_opt_bytecap_x_(size))
...
#define _Deref_prepost_opt_z_bytecap_(size)                                                                            \
	_SAL1_1_Source_(                                                                                                   \
			_Deref_prepost_opt_z_bytecap_, (size), _Deref_pre_opt_z_bytecap_(size) _Deref_post_opt_z_bytecap_(size))
...
#define _Deref_prepost_opt_valid_cap_(size)                                                                            \
	_SAL1_1_Source_(                                                                                                   \
			_Deref_prepost_opt_valid_cap_, (size), _Deref_pre_opt_valid_cap_(size) _Deref_post_opt_valid_cap_(size))
#define _Deref_prepost_valid_bytecap_(size)                                                                            \
	_SAL1_1_Source_(                                                                                                   \
			_Deref_prepost_valid_bytecap_, (size), _Deref_pre_valid_bytecap_(size) _Deref_post_valid_bytecap_(size))
...
#define _Deref_prepost_opt_bytecount_(size)                                                                            \
	_SAL1_1_Source_(                                                                                                   \
			_Deref_prepost_opt_bytecount_, (size), _Deref_pre_opt_bytecount_(size) _Deref_post_opt_bytecount_(size))
...
#define _SA_annotes3(n, pp1, pp2, pp3)                                                                                 \
	[SAL_annotes(Name = #n, p1 = _SA_SPECSTRIZE(pp1), p2 = _SA_SPECSTRIZE(pp2), p3 = _SA_SPECSTRIZE(pp3))]
...
#define __In_impl_                                                                                                     \
	[SA_Pre(Valid = SA_Yes)][SA_Pre(Deref = 1, Notref = 1, Access = SA_Read)] __declspec("SAL_pre SAL_valid")
...
#elif defined(_MSC_EXTENSIONS) && !defined(MIDL_PASS) && !defined(__midl) && !defined(RC_INVOKED) &&                   \
		defined(_PFT_VER) && _MSC_VER >= 1400 /*IFSTRIP=IGN*/ // ][
...
#define __out_z_opt                                                                                                    \
	_SAL1_Source_(__out_z_opt, (), __post __Valid __refparam __post __nullterminated __pre_except_maybenull)
#define __out_ecount_z(size)                                                                                           \
	_SAL1_Source_(__out_ecount_z, (size), __ecount(size) __post __Valid __refparam __post __nullterminated)
#define __out_bcount_z(size)                                                                                           \
	_SAL1_Source_(__out_bcount_z, (size), __bcount(size) __post __Valid __refparam __post __nullterminated)
...
#define __deref_inout_z_opt                                                                                            \
	_SAL1_Source_(                                                                                                     \
			__deref_inout_z_opt, (), __deref_inout_opt __pre __deref __nullterminated __post __deref __nullterminated)
...
#define __deref_opt_out_ecount_part(size, length)                                                                      \
	_SAL1_Source_(                                                                                                     \
			__deref_opt_out_ecount_part, (size, length), __deref_out_ecount_part(size, length) __pre_except_maybenull)
#define __deref_opt_out_bcount_part(size, length)                                                                      \
	_SAL1_Source_(                                                                                                     \
			__deref_opt_out_bcount_part, (size, length), __deref_out_bcount_part(size, length) __pre_except_maybenull)
...
#define __deref_opt_inout_z                                                                                            \
	_SAL1_Source_(                                                                                                     \
			__deref_opt_inout_z, (), __deref_opt_inout __pre __deref __nullterminated __post __deref __nullterminated)
...
#define __deref_opt_out_ecount_z_opt(size)                                                                             \
	_SAL1_Source_(                                                                                                     \
			__deref_opt_out_ecount_z_opt, (size), __deref_opt_out_ecount_opt(size) __post __deref __nullterminated)
#define __deref_opt_out_bcount_z_opt(size)                                                                             \
	_SAL1_Source_(                                                                                                     \
			__deref_opt_out_bcount_z_opt, (size), __deref_opt_out_bcount_opt(size) __post __deref __nullterminated)
